        ...
        <form action="<?php echo $base_url ?>/negocio/ng_tasa_cambio.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <select class="form-control" name="id_moneda_o">
              <?php foreach ($monedas as $moneda) : ?>
                <option <?php echo $tasa_cambio->__GET('id_moneda_o') == $moneda->__GET('id_moneda') ? "selected" : "" ?> value="<?php echo $moneda->__GET('id_moneda') ?>">
          ...
          <div class="mb-3">
            ...
            <select class="form-control" name="id_moneda_c">
              <?php foreach ($monedas as $moneda) : ?>
                <option <?php echo $tasa_cambio->__GET('id_moneda_c') == $moneda->__GET('id_moneda') ? "selected" : "" ?> value="<?php echo $moneda->__GET('id_moneda') ?>">
                  <?php echo ($moneda->__GET('nombre')) ?>
                </option>
              <?php endforeach; ?>
            </select>
          ...
          <div class="mb-3">
            ...
            <select class="form-control" name="mes">
              <?php foreach ($meses as $mes) : ?>
                <option 
                <?php echo $tasa_cambio->__GET('mes') == $mes ? "selected" : "" ?>
                value="<?php echo ($mes) ?>">
                  <?php echo ($mes) ?>
                </option>
              <?php endforeach; ?>
          ...
          <div class="mb-3">
            <label>Año</label>
            <input class="form-control" type="number" step="1" min="1900" value="<?php echo $tasa_cambio->__GET('anio') ?>" name="anio">
          </div>
